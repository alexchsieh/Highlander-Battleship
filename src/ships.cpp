...
void FiveShip::placement(int x, int y, int x1, int y1) { 
    for(int i = 0; i < 12; i++) {
        for (int j = 0; j < 12; j++) {
            matrix[x+1][y+1] = 5;
            if(x == x1) {
...
void FourShip::placement(int x, int y, int x1, int y1) { 
    for(int i = 0; i < 12; i++) {
        for (int j = 0; j < 12; j++) {
            matrix[x+1][y+1] = 4;
            if(x == x1) {
...
void ThreeShip::placement(int x, int y, int x1, int y1) { 
    for(int i = 0; i < 12; i++) {
        for (int j = 0; j < 12; j++) {
            matrix[x+1][y+1] = 3;
            if(x == x1) {
...
void TwoShip::placement(int x, int y, int x1, int y1) { 
    for(int i = 0; i < 12; i++) {
        for (int j = 0; j < 12; j++) {
            matrix[x+1][y+1] = 2;
            if(x == x1) {
